[README (1).md](https://github.com/user-attachments/files/23380980/README.1.md)
# 🍽️ **점심의 민족**

<div align="center">
<img width="600" height="600" alt="Image" src="https://github.com/user-attachments/assets/604a42e2-7e51-46bd-8e66-8d5648b8d529" />
</div>

**점심의 민족**은 한화시스템 BEYOND SW캠프 수강생들이 캠프 활동 동안 점심시간에 다녀온 음식점에 대한 작성한 리뷰를 모아 **가성비 맛집** 추천을 통해 가격이 저렴한 음식점을 한눈에 알아보기 쉽게 도와주고 모든 기수가 소통할 수 있는 커뮤니티 공간을 만들어서 쉽게 친해질 수 있는 서비스입니다.
...
- 커뮤니티 기능이 포함되어있어 같은 상황에 있는 사람들끼리 **자연스럽게 대화**를 이어갈 수 있습니다.
...
- 같은 세데 같은 상황에 있는 사람들이 모여있는 커뮤니티라서 다른 기수와 다양한 주제와 스터디 활동을 할 수 있습니다.
...
음식 배달 주문을 할 수 있는 대한민국 대표 배달 앱으로 주변 맛집 검색, 리뷰 확인, 할인 쿠폰 제공 등의 기능을 지원하며 사용자 편의성을 높임
광고와 프로모션으로 가계와 소비자를 연결하며, 배달 서비스 외에도 간편 결제 기능을 지원.
...
<img width="2000" height="1413" alt="요구사항 명세서" src="https://github.com/user-attachments/assets/871fbb97-f9bc-45da-8a62-3c4ac75c8882" />

<img width="2000" height="1413" alt="요구사항 명세서" src="https://github.com/user-attachments/assets/aca3498b-20fe-4023-b5bd-44ff349ffeec" />
</details>
<br>
...
<img width="3528" height="1601" alt="ERD" src="https://github.com/user-attachments/assets/14ae76ae-1584-49ae-9613-0abb3b33ae7a" />
</details>
...
<img width="725" height="812" alt="Image" src="https://github.com/user-attachments/assets/f23cf636-e2fe-439d-b570-6afb0959fd2d" />


<img width="726" height="803" alt="Image" src="https://github.com/user-attachments/assets/ff9e3b3d-04d7-43db-972c-11e220cb4a8b" />


<img width="727" height="357" alt="Image" src="https://github.com/user-attachments/assets/fb51e6a3-f8d5-4864-b34c-424773e260d7" />
</details>
...
## 🌇 **8. 프로젝트 종료 후 가능성 및 느낀점**

**작성자 : 정동욱**

한화시스템 BEYOND 부트캠프에 참여하면서, 6개월이라는 기간 동안 좋은 프로젝트를 만들어야 하고, 수입 없이 공부를 이어가야 하는 상황이 부담스럽다는 점을 느꼈다. 이를 바탕으로, 수강생들이 금전적 걱정을 줄이고 공부에 집중할 수 있도록 돕는 프로젝트로 "점심의 민족"을 기획하게 되었다. 이 서비스는 부트캠프 근처 음식점 정보를 배달의 민족 메뉴 현황처럼 시각화하고, 독자적인 가성비 랭킹을 통해 저렴한 음식점을 순위별로 확인할 수 있게 한다. 다만 배달이나 포장 기능은 제공되지 않고, 수강생들이 직접 음식점을 다녀온 후 리뷰를 남기는 방식이다. 또한, 에브리타임처럼 부트캠프 학생뿐 아니라 매니저와 강사도 참여 가능하여, 같은 기수가 아닌 다른 기수와도 커뮤니티를 형성할 수 있어 스터디 기회를 넓힐 수 있다. 이러한 서비스가 발전하면, 한화시스템 부트캠프뿐 아니라 다른 부트캠프에서도 적용 가능하며, 점주 입장에서는 음식 홍보와 함께 수강생 대상 특별 할인 제공 등으로 효과적인 광고 수단이 될 수 있다. 또한 이용자가 적어 유지보수가 간편하다는 점에서도 매력적인 프로젝트라고 생각한다.
